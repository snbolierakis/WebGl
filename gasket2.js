...
window.onload = function init()
{
    ...
    document.getElementById("submitSubs").onclick = function(){
    	tmp = parseInt(document.getElementById("Subdivision").value);
		NumTimesToSubdivide = isNaN(tmp) ? NumTimesToSubdivide : tmp;
...
function triangle( a, b, c )
{
	...
	colors.push(baseColors[rand], baseColors[rand], baseColors[rand]);
}
